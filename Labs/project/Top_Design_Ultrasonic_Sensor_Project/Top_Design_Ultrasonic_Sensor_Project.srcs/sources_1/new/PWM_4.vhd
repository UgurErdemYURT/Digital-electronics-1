...
entity PWM_4 is
    port(
        ...
        PWM4_en_i    : in  std_logic;                        -- Enable signal of the PWM_4 module to let this module know that it has to start counting.
        PWMOutput_o  : out std_logic;                        -- Output of the PWM_4 module (signal goes to buzzer)
        cntTest4_o   : out std_logic_vector(7 - 1 downto 0)  -- This is used for testing purpose and can be removed. Shows us the counter value.
    );
end entity PWM_4;
...
------------------------------------------------------------------------
architecture Behavioral of PWM_4 is
...
begin
    ...
    begin
        case s_cnt is
            ...
            when "0011010" =>         -- At count 26 the PWM module sends out 1 quick signal and internal reset is 0
                PWMOutput_O   <= '1';
                internalReset <= '0';
            ...
            when "1001100" =>         -- At count 76 the PWM module sends out 1 quick signal and internal reset is 0
                PWMOutput_O   <= '1';
                internalReset <= '0';
...
cntTest4_o <= std_logic_vector(s_cnt); -- To be able to see the counter values.
