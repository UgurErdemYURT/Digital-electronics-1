...
entity PWM_3 is
    port(
        ...
        PWM3_en_i    : in  std_logic;                        -- Enable signal of the PWM_3 module to let this module know that it has to start counting.
        PWMOutput_o  : out std_logic;                        -- Output of the PWM_3 module (signal goes to buzzer)
        cntTest3_o   : out std_logic_vector(7 - 1 downto 0)  -- This is used for testing purpose and can be removed. Shows us the counter value.
    );
end entity PWM_3;
...
------------------------------------------------------------------------
architecture Behavioral of PWM_3 is
...
cntTest3_o <= std_logic_vector(s_cnt); -- To be able to see the counter values.
