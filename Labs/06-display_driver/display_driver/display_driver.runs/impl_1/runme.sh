...
HD_PWD='C:/Users/egeme/Digital-electronics-1/Labs/06-display_driver/display_driver/display_driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log driver_7seg_4digits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source driver_7seg_4digits.tcl -notrace
